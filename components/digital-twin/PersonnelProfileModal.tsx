...
export function PersonnelProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl bg-card dark:bg-slate-900/95 border border-border-hairline rounded-2xl shadow-2xl overflow-hidden text-text-primary dark:text-slate-100 flex flex-col md:flex-row max-h-[92vh]">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-3 right-3 z-20 w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 text-text-muted hover:text-text-primary dark:text-slate-400 dark:hover:text-white border border-border-hairline transition"
          title="Close Modal"
        >
          ✕
        </button>
        ...
        <div className="w-full md:w-72 bg-slate-50/80 dark:bg-slate-950/80 border-r border-border-hairline p-4 flex flex-col overflow-y-auto">
          <div className="pb-3 border-b border-border-hairline mb-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-text-muted flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-scic-green dark:text-cyan-400 bg-emerald-500/10 dark:bg-cyan-950/60 px-1.5 py-0.5 rounded border border-emerald-500/30 dark:border-cyan-500/30 font-bold">
              ...
              return (
                <div
                  ...
                  className={`group relative w-full flex items-center gap-2.5 p-2 rounded-xl text-left transition ${
                    isSelected
                      ? "bg-emerald-500/10 dark:bg-sky-950/70 border border-emerald-500/40 dark:border-sky-500/50 shadow-sm"
                ...
                >
                  ...
                  >
                    <div className="relative w-10 h-10 rounded-lg overflow-hidden border border-border-hairline shrink-0 bg-slate-100 dark:bg-slate-900">
                      <Image
                        src={p.avatarUrl}
                        alt={p.name}
                        fill
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-semibold truncate text-text-primary dark:text-slate-200 group-hover:text-scic-green dark:group-hover:text-white">
                        {p.nickname}
                      </div>
                  ...
                  <button
                    ...
                    className="opacity-60 group-hover:opacity-100 p-1.5 rounded-lg bg-slate-100 hover:bg-emerald-500 hover:text-white dark:bg-slate-800/80 dark:hover:bg-cyan-600 text-text-muted dark:text-slate-400 border border-border-hairline transition shrink-0"
        ...
        <div className="flex-1 p-6 overflow-y-auto flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 pb-5 border-b border-border-hairline">
            ...
            <div className="flex-1 text-center sm:text-left space-y-2">
              ...
              <div className="text-sm font-medium text-scic-green dark:text-sky-400">
                {currentPerson.role}
              </div>
              <div className="text-xs text-text-muted flex items-center justify-center sm:justify-start gap-3 pt-0.5">
              ...
              <div className="bg-slate-50/80 dark:bg-slate-950/60 border border-border-hairline rounded-xl p-2.5 text-left">
                <div className="text-[10px] font-bold uppercase tracking-wider text-scic-green dark:text-cyan-400 flex items-center gap-1.5 mb-1">
                  <Briefcase className="w-3 h-3 text-scic-green dark:text-cyan-400" />
              ...
              <div className="pt-1 flex justify-center sm:justify-start">
                <button
                  onClick={() => handleLocate()}
                  className="w-full sm:w-auto px-4 py-2 rounded-xl scic-gradient-btn font-mono text-xs font-bold flex items-center justify-center gap-2.5 shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] group"
                >
                  ...
                  <span className="text-[11px] text-white/90 group-hover:translate-x-1 transition-transform">
                    ➔
                  </span>
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-5 flex-1">
            <div className="bg-slate-50/80 dark:bg-slate-950/50 border border-border-hairline p-3.5 rounded-xl space-y-1">
              <div className="text-[11px] font-semibold text-text-muted uppercase tracking-wider">
                Official License & Safety Accreditation
              </div>
              <div className="text-xs font-mono text-amber-600 dark:text-amber-300 font-semibold">
            ...
            <div className="bg-slate-50/80 dark:bg-slate-950/50 border border-border-hairline p-3.5 rounded-xl space-y-1">
              ...
              <div className="text-xs text-text-primary dark:text-slate-200">
                {currentPerson.shift}
              </div>
            </div>

            <div className="bg-slate-50/80 dark:bg-slate-950/50 border border-border-hairline p-3.5 rounded-xl space-y-1 sm:col-span-2">
              <div className="text-[11px] font-semibold text-text-muted uppercase tracking-wider">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="text-[11px] font-semibold text-text-muted uppercase tracking-wider group-hover:text-scic-green dark:group-hover:text-cyan-300 transition-colors flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5 text-scic-green dark:text-cyan-400" />
              ...
              <div className="text-xs text-text-secondary dark:text-slate-300 flex items-center gap-2">
                <span className="font-medium text-text-primary dark:text-slate-100 group-hover:text-scic-green dark:group-hover:text-cyan-200 transition-colors">
          ...
          {/* Footer Note */}
          <div className="pt-3 border-t border-border-hairline flex items-center justify-between text-[11px] text-text-muted">
            ...
            <span className="text-text-muted font-mono flex items-center gap-1">
              <Sparkles className="w-3 h-3 text-scic-green dark:text-cyan-400" />
